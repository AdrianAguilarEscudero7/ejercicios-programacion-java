...
public class Ejercicio36 {
  public static void main(String[] args) {
    ...
    System.out.print("\nBienvenid@, este programa devolverá sólo los números primos de un array");
    ...
    // Realiza el filtrado de números primos
    Array.muestraArrayInt(Otros.filtraPrimos(array));
  }
}
